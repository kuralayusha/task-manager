  ...
  return (
    <header className="flex justify-start bg-white dark:bg-[#2b2c37] dark:bg-dark-gray h-16 sm:h-20 lg:h-24 w-full flex-shrink-0">
      ...
      <div className="flex relative px-4  transition-all  border-gray-200 dark:border-gray-700 justify-between w-full items-center">
        ...
        <div className="flex items-center">
          <button
            className="px-4 sm:px-5 sm:py-3 text-sm rounded-full bg-[#575FC6] text-white font-semibold flex items-center justify-center"
            onClick={() => {
...
const Logos = () => {
  ...
  // Aynı div yapısını sunucu ve ilk istemci render'da kullan (hydration hatasını önler)
  if (!mounted) {
    return (
